 ...
 *
 * Kinds and labels live here because the server validates against them; the
 * icon each one draws is a client concern and lives in lib/reactions.ts.
 */
...
export const REACTION_FALLBACK = { kind: "like", label: "Like" };
